...
float linear = 155, linear_turn = 170, angular = 170, d = 0;
...
//end for zigzag---------------------------------------------------------------
    ...
    ros::Publisher cmd_pub = n.advertise<geometry_msgs::Twist>("/mov_cmd", 50);
    ...
    ros::Publisher dir_pub = n.advertise<std_msgs::Int8>("/dir_cmd", 10);
